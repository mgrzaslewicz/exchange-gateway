...
class FileKeyValueRepositoryTest {
    ...
    fun shouldKeepLastNVersions() {
        val tested = FileKeyValueRepository(clock = com.autocoin.exchangegateway.spi.exchange.clock.QueueClock.of(1, 2, 3, 4), fileExtension = ".json")
    ...
    fun shouldNotRemoveOtherKeysWhenKeepLastNVersions() {
        val tested = FileKeyValueRepository(clock = com.autocoin.exchangegateway.spi.exchange.clock.QueueClock.of(1, 2, 3), fileExtension = ".json")
        tested.saveNewVersion(directory = tempFolder, key = "test", "value1")
        tested.saveNewVersion(directory = tempFolder, key = "test", "value2")
