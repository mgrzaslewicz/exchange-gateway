...
class XchangeAuthorizedOrderServiceFactory(
    ...
    override fun createAuthorizedOrderService(exchangeName: ExchangeName, apiKey: Supplier<ApiKey>): XchangeAuthorizedOrderService {
