...
interface UserExchangeServicesFactory {
    fun createTickerProvider(exchangeName: String): UserExchangeTickerProvider
    fun createTickerProvider(exchangeName: String, publicKey: String, secretKey: String, userName: String?): UserExchangeTickerProvider
...
class XchangeUserExchangeServicesFactory(private val xchangeFactory: XchangeFactory, private val xchangeMetadataFile: XchangeMetadataFile) : UserExchangeServicesFactory {
    ...
    override fun createMetadataProvider(exchangeName: String, publicKey: String, secretKey: String, userName: String?): UserExchangeMetadataProvider {
        return DefaultUserExchangeMetadataProvider(exchangeName, ExchangeMetadata.fromExchange(getXchange(exchangeName, publicKey, secretKey, userName)))
    }
    ...
    override fun createMetadataProvider(exchangeName: String): UserExchangeMetadataProvider {
        ...
        return DefaultUserExchangeMetadataProvider(exchangeName, ExchangeMetadata.fromExchange(getXchange(supportedExchange, exchangeSpec)))
    }
    ...
    override fun createTickerProvider(exchangeName: String): UserExchangeTickerProvider {
        val supportedExchange = enumFromNameOrThrow(exchangeName)
        val exchangeSpec = ExchangeSpecification(supportedExchange.exchangeClass.java)
        return XchangeUserExchangeTickerProvider(getXchange(supportedExchange, exchangeSpec).marketDataService)
    }

    override fun createTickerProvider(exchangeName: String, publicKey: String, secretKey: String, userName: String?): UserExchangeTickerProvider {
        return XchangeUserExchangeTickerProvider(getXchange(exchangeName, publicKey, secretKey, userName).marketDataService)
    }
    ...
    override fun createTickerListenerRegistrar(exchangeName: String, publicKey: String, secretKey: String, userName: String?): TickerListenerRegistrar {
        val supportedExchange = enumFromNameOrThrow(exchangeName)
        return DefaultTickerListenerRegistrar(supportedExchange, createTickerProvider(exchangeName, publicKey, secretKey, userName))
    }

    override fun createTickerListenerRegistrar(exchangeName: String): TickerListenerRegistrar {
        val supportedExchange = enumFromNameOrThrow(exchangeName)
        return DefaultTickerListenerRegistrar(supportedExchange, createTickerProvider(exchangeName))
    }
