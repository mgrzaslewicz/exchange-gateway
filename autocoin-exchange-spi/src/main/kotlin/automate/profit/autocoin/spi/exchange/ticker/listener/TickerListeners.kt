...
interface TickerListeners {
    fun addTickerListener(exchangeName: ExchangeName, currencyPair: CurrencyPair, listener: TickerListener): Boolean
    fun removeTickerListener(exchangeName: ExchangeName, currencyPair: CurrencyPair, listener: TickerListener): Boolean
