...
interface OrderBookListeners {
    fun addOrderBookListener(exchangeName: ExchangeName, currencyPair: CurrencyPair, listener: OrderBookListener): Boolean
    fun removeOrderBookListener(exchangeName: ExchangeName, currencyPair: CurrencyPair, listener: OrderBookListener): Boolean
