...
class CurrencyPairMetadataApplier {
     ...
     */
    private fun getMinimumAmountForPrice(
        price: BigDecimal,
        metadata: CurrencyPairMetadata,
    ): BigDecimal {
    ...
    private fun applyScale(
        value: BigDecimal,
        scale: Int,
    ) = value.setScale(scale, RoundingMode.DOWN).also { logger.debug { "applyScale($value, $scale) = $it" } }
